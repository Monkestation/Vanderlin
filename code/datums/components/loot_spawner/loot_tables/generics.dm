/datum/loot_table/random
	...
	loot_table = list(
		list(
			...
			/obj/item/clothing/shirt/dress/silkdress/colored/random = 3,
			/obj/item/clothing/shirt/rags = 4,
			/obj/item/clothing/shirt/tunic/colored/random = 4,
			/obj/item/cooking/pan = 2,
			/obj/item/grapplinghook = 0.5,
			/obj/item/grown/log/tree/stake = 4,
			/obj/item/instrument/accord = 1,
			/obj/item/instrument/guitar = 1,
			/obj/item/instrument/hurdygurdy = 1,
			/obj/item/instrument/viola = 1,
			/obj/item/kitchen/spoon/iron = 2,
			/obj/item/natural/bundle/fibers = 4,
			/obj/item/natural/bundle/silk = 2,
			/obj/item/natural/bundle/plank = 2,
			/obj/item/natural/bundle/curred_hide = 2,
			/obj/item/natural/cloth/bandage = 4,
			/obj/item/natural/dirtclod = 2,
			/obj/item/natural/fur/cabbit = 2,
			/obj/item/natural/fur/direbear = 1,
			/obj/item/natural/fur/gote = 2,
			/obj/item/natural/fur/volf = 2,
			/obj/item/ore/iron = 1,
			/obj/item/ore/silver = 0.5,
			/obj/item/perfume/random = 3,
			/obj/item/reagent_containers/glass/bottle/waterskin = 3,
			/obj/item/reagent_containers/glass/cup/steel = 3,
			/obj/item/reagent_containers/glass/cup/glassware/shotglass = 3,
			/obj/item/restraints/legcuffs/beartrap/armed/camouflage = 2,
			/obj/item/rope/chain = 3,
			/obj/item/storage/backpack/backpack = 3,
			/obj/item/storage/backpack/satchel = 6,
			/obj/item/storage/belt/leather = 3,
			/obj/item/storage/handbasket = 3,
			/obj/item/storage/meatbag = 4,
			/obj/item/storage/messkit = 2,
			/obj/item/textbook/novice/medicine = 3,
			/obj/item/textbook/apprentice/medicine = 2,
			/obj/item/textbook/journeyman/medicine = 1,
			/obj/item/weapon/shovel = 5,
			/obj/item/bodypart/l_arm/prosthetic/wood = 2,
			/obj/item/bodypart/r_arm/prosthetic/wood = 2,
			/obj/item/bodypart/l_leg/prosthetic/wood = 2,
			/obj/item/bodypart/r_leg/prosthetic/wood = 2,
			/obj/item/book/noc = 4,
			/obj/item/book/playerbook = 4,
			/obj/item/book/random_book/legends = 3,
			/obj/item/book/random_book/thesis = 3,
			/obj/item/clothing/gloves/leather = 4,
			/obj/item/flint = 6,
			/obj/item/grown/log/tree/small = 3,
			/obj/item/weapon/knife/villager = 3,
		)
	)
	base_max = 2
