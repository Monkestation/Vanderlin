...
/datum/component/ghost_vessel/UnregisterFromParent()
	...
	if(!vessel_item_type)
		UnregisterFromParent(parent, list(COMSIG_ATOM_ITEM_INTERACTION, COMSIG_PARENT_QDELETING))
...
/datum/component/ghost_vessel/proc/begin_ghost_offer()
	...
	var/list/candidates = pollCandidatesForMobWhitelisted(
		"A vessel at [living_parent.loc] awaits a soul. Do you wish to inhabit it?",
		null,
		null,
		null,
		100,
