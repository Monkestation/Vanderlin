...
/obj/item/gun/ballistic/revolver/grenadelauncher/crossbow
	...
	accepted_magazine_type = /obj/item/ammo_box/magazine/internal/xbow
...
/obj/item/gun/ballistic/revolver/grenadelauncher/crossbow/process_fire(atom/target, mob/living/user, message = TRUE, list/modifiers, zone_override, bonus_spread = 0)
	...
	for(var/obj/item/ammo_casing/CB in get_ammo_list(FALSE, TRUE))
		...
		if(perception > 8)
			...
			if(perception > 10)
				loaded_projectile.damage = loaded_projectile.damage * (perception / 10)
		loaded_projectile.damage *= damfactor // Apply damfactor multiplier regardless of PER.
		loaded_projectile.bonus_accuracy += (GET_MOB_SKILL_VALUE_OLD(user, /datum/attribute/skill/combat/crossbows) * 3) //+3 accuracy per level in crossbows
	cocked = FALSE
	. = ..()
	if(.)
...
/obj/item/ammo_box/magazine/internal/xbow
