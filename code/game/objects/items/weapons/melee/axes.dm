...
/obj/item/weapon/axe/iron/nsapo
	name = "iron kasuyu"
	desc = "An iron axe hailing from the Queendom of Lakkari. Great for felling trees and foes alike."
...
/obj/item/weapon/axe/steel/nsapo
	name = "steel kasuyu"
	desc = "A steel axe hailing from the Queendom of Lakkari. Great for felling trees and foes alike."
	icon = 'icons/roguetown/weapons/32/lakkari.dmi'
