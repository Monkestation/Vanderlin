...
/obj/item/weapon/sword/decorated
	...
	sellprice = VALUE_STEEL_ITEM + VALUE_GOLD_ITEM + SKILL_2
...
/obj/item/weapon/sword/silver
	...
	max_integrity = INTEGRITY_STRONG
	sellprice = VALUE_SILVER_ITEM + SKILL_3
	last_used = 0
...
/obj/item/weapon/sword/long
	...
	slot_flags = ITEM_SLOT_BACK|ITEM_SLOT_HIP
	dropshrink = 0.75
	sellprice = VALUE_STEEL_ITEM*2 + SKILL_2
	grid_height = 96
	grid_width = 64
...
/obj/item/weapon/sword/long/forgotten
	...
	wbalance = -1
	wdefense = GREAT_PARRY
	sellprice = VALUE_SILVER_ITEM + VALUE_STEEL_ITEM + SKILL_3
	last_used = 0
...
/obj/item/weapon/sword/long/decorated
	...
	max_integrity = 300
	smeltresult = /obj/item/ingot/silver
	sellprice = VALUE_SILVER_ITEM*2 + VALUE_GOLD_ITEM + SKILL_3
	last_used = 0
	melting_material = /datum/material/silver
	melt_amount = 75
...
/obj/item/weapon/sword/long/greatsword
	...
	minstr = 11
	wbalance = EASY_TO_DODGE
	sellprice = VALUE_STEEL_ITEM*3 + SKILL_3
...
/obj/item/weapon/sword/long/greatsword/zwei
	...
	max_integrity = INTEGRITY_STRONG
	sellprice = VALUE_IRON_ITEM*3 + SKILL_2
	melting_material = /datum/material/iron
	melt_amount = 225
