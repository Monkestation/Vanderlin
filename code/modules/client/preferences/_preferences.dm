...
/datum/preferences/proc/set_choices(mob/user, limit = 15, list/splitJobs = list("Captain", "Priest", "Merchant", JOB_BUTLER, "Village Elder"), widthPerColumn = 400, height = 620)
	if(!SSjob)
		return
