...
/datum/orderless_slapcraft/food/pie/kirunabal
	name = "unbaked kirunabal pie"
	requirements = list(/obj/item/reagent_containers/food/snacks/produce/mushroom/kirunabal = 3
		)
	overlay_state = "fill_pot"
	output_item = /obj/item/reagent_containers/food/snacks/raw_pie/kirunabal
