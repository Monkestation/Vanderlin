...
/datum/repeatable_crafting_recipe/crafting/gingerbreadman
	name = "man"
	requirements = list(
		/obj/item/reagent_containers/food/snacks/flat_gingerbread= 1,
	)
	tool_usage = list(
		/obj/item/weapon/knife = list(span_notice("cutting dough into shape..."), span_notice("cutting dough into shape..."), 'sound/foley/dropsound/food_drop.ogg'),
	)
...
/datum/repeatable_crafting_recipe/crafting/gingerbreadnoc
	name = "moon"
	requirements = list(
		/obj/item/reagent_containers/food/snacks/flat_gingerbread= 1,
	)
	...
	starting_atom = /obj/item/weapon/knife
	allow_inverse_start = FALSE
	output = /obj/item/reagent_containers/food/snacks/foodbase/raw_noc
	craft_time = 3 SECONDS

/datum/repeatable_crafting_recipe/crafting/gingerbreadastrata
	name = "solar"
	requirements = list(
		/obj/item/reagent_containers/food/snacks/flat_gingerbread= 1,
	)
	...
	starting_atom = /obj/item/weapon/knife
	allow_inverse_start = FALSE
	output = /obj/item/reagent_containers/food/snacks/foodbase/raw_astrata
	craft_time = 3 SECONDS

/datum/repeatable_crafting_recipe/crafting/gingerbreadpsycross
	name = "psycross"
	requirements = list(
		/obj/item/reagent_containers/food/snacks/flat_gingerbread= 1,
	)
	...
	starting_atom = /obj/item/weapon/knife
	allow_inverse_start = FALSE
	output = /obj/item/reagent_containers/food/snacks/foodbase/raw_psycross
	craft_time = 3 SECONDS
