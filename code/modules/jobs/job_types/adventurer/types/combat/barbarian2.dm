/datum/attribute_holder/sheet/job/barbarian2
...
/datum/job/advclass/combat/barbarian2
	title = "Barbarian2"
	...
	outfit = /datum/outfit/adventurer/barbarian2
	category_tags = list(CTAG_ADVENTURER)
//	roll_chance = 0
	cmode_music = 'sound/music/cmode/adventurer/CombatOutlander2.ogg'

	attribute_sheet = /datum/attribute_holder/sheet/job/barbarian2
...
/datum/job/advclass/combat/barbarian2/on_roundstart(mob/living/carbon/human/spawned, client/player_client)
	. = ..()
...
/datum/outfit/adventurer/barbarian2
