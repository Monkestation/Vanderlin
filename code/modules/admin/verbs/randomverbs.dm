	...
	switch(option)
		...
		if("Specific God")
			...
			if(first_time && first_time_message)
				to_chat(target, SPAN_GOD_FIRST_FEEL("<span class='god_[ckey(chosen_god)]'>[first_time_message]</span>"))
...
/proc/get_god_atmosphere_message(chosen_god)
	...
	switch(chosen_god)
		if("Astrata")
			atmosphere_message = "Your body feels warm… it’s as if the sun itself were beaming against your skull… amidst this sensation, the voice of a woman, authoritative, radiant, demanding absolute attention, brands itself in your head."
		if("Noc")
			atmosphere_message = "Symbols dance in the corner of your vision. For a moment, you are enlightened.. Your mind is imprinted with runes. You are able to decipher the voice of a man. Formal, contemplative, perhaps a little haughty even."
		if("Abyssor")
			atmosphere_message = "The rumbling of clouds, the crashing of waves, the smell of salt. You are flooded with a sensation that you could only describe as being lost at sea… the crackling lightning above gives way to a voice. Disgruntled, weary and drowned, the words that you can make out are spoken in a gruff tone."
		if("Dendor")
			atmosphere_message = "The chatter and sounds around you fade into an ambience… Your ears pick up wolves growling, chirping of birds… even the faintest movements of the trees swaying with the wind. A peaceful meditation, violently interrupted several loud thuds. The rustling of the leaves speak in a gravelly voice. Indignant and brittle, as if on the verge of snapping like a twig."
		if("Ravox")
			atmosphere_message = "A sudden rush of righteousness usurps your emotions, the clashing of blades, the symphony of steel on steel. But just abruptly, it fades into a harsh pain of faded glory. As if nostalgia had plunged it dagger into your chest. With a hoarse, mournful yet solemn tone, Justice speaks to you."
		if("Malum")
			atmosphere_message = "Your perspective abruptly shifts on the world. Every wall, every gate, even the pavement you’d walk onto clicks to you. The whole world is a big puzzle, a feat of engineering to the inspired mind. Your mind races with ideas, striking you with plan after plan. A loud sizzle snaps you out of this trance, someone speaks to you in a tempered, detached voice, with few words. Direct, and to the point, as if preoccupied with something."
		if("Eora")
			atmosphere_message = "All manner of troubles seem to evaporate. Everyone, everything around you appeals to have grown softer, more docile. A comfort akin to a mother tucking in her child, your worries are hushed away for now. Amidst this dreamy state, a soft-spoken, appeasing voice cradles your mind. Her tone is compassionate, as if she were right there with you."
		if("Xylix")
			atmosphere_message = "Life is so comical… the drama you will cause will be astronomical! Wouldn’t you just love a show, you should’ve been laughing five minutes ago! The air is light and witty, you begin to truly enjoy this city… Ambiguous is this voice… festive,whimsical, and carefree.. The peak of free choice!"
		if("Pestra")
			atmosphere_message = "The body works in curious ways, in fact, have you ever truly taken a moment to question it? A balance of humors, substances flow through the veins, alchemical agents to modify the parameters of your biology. Yet ponder more, if you were to delve into this, you’d at least need a notebook and a few samples to compare. Pensive, hypercritical, and apathetic, she speaks as if this were an examination."
		if("Necra")
			atmosphere_message = "Remember you must die. All things will come to an end. It is a grim thought, but not without its merits. In fact, it brings some peace knowing there is a place to look forward to. It is a cold thought, like the breeze of autumn after a long summer. Stillness is in the air. Silence and Serenity. The disembodied voice that follows does not break this silence, it harmonizes with it.  Sedative, ancient, and steady, her message to you is in whispers"
		if("Matthios")
			atmosphere_message = "A distant coin rolls. You hear it inching every closer to you… until you can only focus on it. It rolls down the split of your mind using the groves within your brain as a path until it stops with a sharp clink. Ideations of wealth beyond measure, yours for the taking, only disturbed by the chuckling of a man. He speaks with many pauses… a trial of your patience, with taunting chuckles between every phrase. Cunning and almost condescending, his breathy voice pings your ears."
		if("Baotha")
			atmosphere_message = "You feel a sudden drain on your body, it is soothing… as if your troubles have been uplifted, replaced by an ever-sweet ecstasy. All the world seems colorful, vibrant, exciting. You must experience it all, you must live in the moment and relish all it has to offer you. A feminine, honey voice woman hums in your mind. She sounds silvery, and singsong, an addicting melody like a siren."
		if("Graggar")
			atmosphere_message = "Your heart begins to race. Blood rushes to your head. Your hands clench into a fist, a rhythmic thumping takes over your hearing. Your eyes narrow down on everything, everyone. You size them all up. There is some primal and feral urge to fight, to shout, to let loose. You can hardly keep your body from lurching forward. As you tremble with the sudden surge of adrenaline, a deep guttural laugh. He roars, a raucous, abrasive and brash voice follows."
		if("Zizo")
			atmosphere_message = "A swirl of shadows overtake your senses, the sphere that is your mind is penetrated and swallowed whole. You are lost in the dark, engulfed and surrounded. As if entombed in a vast void of nothingness. A purple light flickers in your vision, profane, offering no comfort from the dark, however drawing your attention. The voice of a woman, sharp, conceitful, and ensnaring. Her voice is ephemeral, and ghastly. A coldness takes hold of you, bone-chilling and black as death. When she speaks, a shiver runs down your spine."
