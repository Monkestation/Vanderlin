...
/mob/dead/observer/verb/set_final_words()
	...
	if(!ishuman(mind.current))
		to_chat(src, "<span class='warning'>I am not sophisticated enough to leave final words...</span>")
		return
	var/mob/living/carbon/human/body = mind.current

	if(body.funeral)
		to_chat(src, "<span class='warning'>My body has already been laid to rest!</span>")
		return
