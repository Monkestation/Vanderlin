...
/mob/living/carbon/human/species/halforc/base/average
...
/mob/living/carbon/human/species/halforc/base/average/naked
...
/mob/living/carbon/human/species/halforc/base/average/light_gear
	stat_prefabs = list(/datum/mob_prefab/stats/average)
	outfit_prefabs = list(/datum/mob_prefab/loadout/light)
...
/mob/living/carbon/human/species/halforc/base/average/medium_gear
	stat_prefabs = list(/datum/mob_prefab/stats/average)
	outfit_prefabs = list(/datum/mob_prefab/loadout/medium)
...
/mob/living/carbon/human/species/halforc/base/average/heavy_gear
	stat_prefabs = list(/datum/mob_prefab/stats/average)
	outfit_prefabs = list(/datum/mob_prefab/loadout/medium)
