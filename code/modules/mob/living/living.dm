...
/mob/living/stop_pulling(pulling_broke_free = FALSE)
	if(pulling_broke_free && ismob(pulling))
		...
		if(attributes)
			wrestling_cooldown_reduction = 0.1 SECONDS * GET_MOB_SKILL_VALUE_OLD(src, /datum/attribute/skill/combat/wrestling)
...
/mob/living/proc/grab_counter_attack(mob/living/carbon/attacker)
	...
	if(attributes)
		counter_chance += 4 * (GET_MOB_SKILL_VALUE_OLD(src, /datum/attribute/skill/combat/wrestling) + GET_MOB_SKILL_VALUE_OLD(src, /datum/attribute/skill/combat/unarmed))
