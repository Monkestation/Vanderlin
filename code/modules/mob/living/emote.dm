...
/proc/send_prayer(mob/living/follower, prayer, patron_name)
	...
	var/message = span_admin("[span_prefix("PRAYER: ")]<span class=\"message linkify\">[ident_string] [ADMIN_SM(follower)] [ADMIN_FLW(follower)] prays: <span class='god_[lowercase_god]'>[html_encode(prayer)]</span></span>")
