...
/obj/effect/mapping_helpers/structure/grave_spawner
	...
	var/list/gravefence_spawn_list = list() //TODO REMOVE

	// TODO: Corpse handling, foundation for loot?
...
/obj/effect/mapping_helpers/structure/grave_spawner/payload(obj/structure/payload)
	...
	if(spawn_gravefence)
		...
		if(length(gravefence_spawn_list)) //TODO, when T3 generic headstone made, we remake this to cancel and send debug if helper cannot find a fence/headstone
