...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"Thorough Analysis" = TRAIT_EMPATH,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_EMPATH = "I can understand someone's ailments more thoroughly.",
	...
	TRAIT_BLACK_BRIAR = span_briar("The bramble writhes beneath my skin, but low exposure over the years has made me more tolerant if I don't make it worse."),
