...
#define ZTRAITS_TOWN list(ZTRAIT_WEATHER_STUFF = TRUE, ZTRAIT_LINKAGE = CROSSLINKED, ZTRAIT_TOWN = TRUE)
#define ZTRAITS_OUTLAND list(ZTRAIT_LINKAGE = CROSSLINKED, ZTRAIT_LEYLINES = TRUE)
