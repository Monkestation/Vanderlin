...
#define VALUE_LEATHER_ARMOR			M_LEATHER*2+W_MINOR+M_MISC
#define VALUE_LEATHER_ARMOR_FUR		VALUE_FUR_ARMOR+M_FUR //Some have an extra fur. This covers it. I guess.
...
#define VALUE_LEATHER_HELMET		M_LEATHER*2+W_MINOR+M_MISC
