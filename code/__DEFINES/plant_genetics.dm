...
#define DEFAULT_GROW_TIME 60 MINUTES
#define FAST_GROWING 50 MINUTES
#define VERY_FAST_GROWING 40 MINUTES

#define SLOW_PRODUCE_TIME 40 MINUTES
#define DEFAULT_PRODUCE_TIME 30 MINUTES
#define FAST_PRODUCE_TIME 20 MINUTES
