...
#define STRIP_HTML_SIMPLE(text, limit) (copytext(GLOB.angular_brackets.Replace(text, ""), 1, limit))

/// Removes everything enclose in < and > inclusive of the bracket, and limits the length of the message.
#define STRIP_HTML_FULL(text, limit) (copytext(GLOB.html_tags.Replace(text, ""), 1, limit))
