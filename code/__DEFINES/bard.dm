...
#define RHYTHM_REGEN_TICK 0.25 // Heal-over-time per second (compare: miracle = 1.0, hymn = 0.6)
...
#define CRESCENDO_MENDING_TICK 0.5 // Heal-over-time per second (compare: rhythm_regen = 0.5)
